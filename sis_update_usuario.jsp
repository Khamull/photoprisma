...
%>
  <td align="left">N&iacute;vel de Usu&aacute;rio:</td>
   ...
   <% String teste = "";
   if(!rs.getString("usuarioNivel").equals("null")){
	 	if(rs.getString("usuarioNivel").equals("1")){
	 		teste = "Gerencia";%>
	 		<option selected="selected" value="<%=rs.getString("usuarioNivel")%>"><%=teste %></option>
	 	<%}
	 	if(rs.getString("usuarioNivel").equals("2")){
	 		teste = "Atendimento";	 %>		
	 		<option selected="selected" value="<%=rs.getString("usuarioNivel")%>"><%=teste%></option>
		<%}
		
		if(rs.getString("usuarioNivel").equals("3")){
			teste = "Arte Finalista";%>		
	 		<option selected="selected" value="<%=rs.getString("usuarioNivel")%>"><%=teste%></option>
		<%}
		if(rs.getString("usuarioNivel").equals("4")){
			teste = "Impressão";%>		
	 		<option selected="selected" value="<%=rs.getString("usuarioNivel")%>"><%=teste%></option>
		<%}
		if(rs.getString("usuarioNivel").equals("5")){
			teste = "Acabamento";%>		
	 		<option selected="selected" value="<%=rs.getString("usuarioNivel")%>"><%=teste%></option>
		<%}
		if(rs.getString("usuarioNivel").equals("6")){
			teste = "Instalação";%>		
	 		<option selected="selected" value="<%=rs.getString("usuarioNivel")%>"><%=teste%></option>
		<%}
		if(rs.getString("usuarioNivel").equals("7")){
			teste = "Vendas";%>		
	 		<option selected="selected" value="<%=rs.getString("usuarioNivel")%>"><%=teste%></option>
		<%}
		if(rs.getString("usuarioNivel").equals("8")){
			teste = "Produção";%>		
	 		<option selected="selected" value="<%=rs.getString("usuarioNivel")%>"><%=teste%></option>
		<%}
   }%>
