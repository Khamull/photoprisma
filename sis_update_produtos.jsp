...
rs02 = st02.executeQuery(produto.pesquisaProdutoID());
%>
...
<tr>
 ...
 <form name="form1" method="post" action="sis_update_manager_produtos.jsp" onsubmit="return verForm(this)">
 ...
 <%} %>
  <tr>
   <td colspan="6" align="center"><strong>CADASTRO DE PRODUTOS</strong></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <input type="hidden" value="<%=request.getParameter("produtoID") %>" name="produtoID"/>
