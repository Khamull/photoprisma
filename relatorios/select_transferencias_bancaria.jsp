...
function abreRelatorio(diaA, mesA, anoA, diaB, mesB, anoB){
	window.open('rep_transferencias_bancarias.jsp?diaA='+diaA+'&mesA='+mesA+'&anoA='+anoA+'&diaB='+diaB+'&mesB='+mesB+'&anoB='+anoB, 'Retiradas', 'width = 800; height = 600; scrollbars=yes')
}
...
<form name="form1" method="post">
 <table align="center" width="759">
  <tr bgcolor="#EEEEEE">
   <td height="35" colspan="9" align="center"><strong>PESQUISE TODAS AS TRANSFER&Ecirc;NCIAS BANC&Aacute;RIAS REALIZADAS DENTRO DE UM PER&Iacute;ODO</strong></td>
  </tr>
  <tr>
...
%>
 <script type="text/javascript">
  abreRelatorio('<%=request.getParameter("diaA")%>', '<%=request.getParameter("mesA")%>', '<%=request.getParameter("anoA")%>', '<%=request.getParameter("diaB")%>', '<%=request.getParameter("mesB")%>', '<%=request.getParameter("anoB")%>');
 </script>
<%}%>
