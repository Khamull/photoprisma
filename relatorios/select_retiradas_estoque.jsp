...
function abreRelatorio(diaA, mesA, anoA, diaB, mesB, anoB){
	window.open('rep_retiradas_estoque.jsp?diaA='+diaA+'&mesA='+mesA+'&anoA='+anoA+'&diaB='+diaB+'&mesB='+mesB+'&anoB='+anoB, 'Retiradas', 'width = 800; height = 600; scrollbars=yes')
}
...
<form name="form1" method="post">
 <table align="center" width="759">
  <tr bgcolor="#EEEEEE">
   <td height="35" colspan="9" align="center"><strong>PESQUISE TODAS AS RETIRADAS  FEITAS NO ESTOQUE DENTRO DE UM PER&Iacute;ODO</strong></td>
  </tr>
  <tr>
