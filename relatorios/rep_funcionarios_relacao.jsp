...
<%
//Pesquisa todos os funcionarios Ativos
rs02 = st02.executeQuery(funcionario.listaFuncionariosOrdenados());
%>
   ...
   <table width="590" height="950" cellpadding="0" cellspacing="0" style="border:1px solid none" align="center">
    <tr>
     <td align="center" valign="top" height="120">
      ...
      <table width="585" height="120" border="0" align="center" cellpadding="0" cellspacing="0">
       ...
       <tr>
        <td height="15" colspan="3" align="center"><strong>RELATORIO - FUNCIONARIOS</strong></td>
       </tr>
       <tr>
        <td align="center" colspan="3"><hr></td>
       </tr>
    ...
    <tr>
     ...
     <%
      ...
      %>
       <tr>
        <td align="left" height="15"><%=datas.converteDeData(String.valueOf(rs02.getDate("funcionarioData"))) %></td>
        <td align="left"></td>
        <td align="left"></td>
        <td align="left"></td>
       </tr>
     ...
     <%
      ...
      %>
       <tr>
        ...
        <td align="left" colspan="2"><strong>Cargo</strong></td>
       </tr>
      <%ln++; %>
     <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      %>
       <tr>
        <td align="left" height="15" colspan="2"><%=rs02.getString("funcionarioNome") %></td>
        <td align="left" colspan="2"><%=rs02.getString("cargoTitulo") %></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      <tr>
       ...
       <tr>
        <td height="15" colspan="3" align="center"><strong>RELATORIO - USUARIOS</strong></td>
       </tr>
       <tr>
        <td align="center" colspan="3"><hr></td>
       </tr>
      ...
      %>
       <tr>
        <td align="left" height="15"><strong>Data de Nascimento</strong></td>
        <td align="left" colspan="2"><strong>RG</strong></td>
     ...
     <%ln++; %>
      ...
      %>
       <tr>
        <td align="left" height="15"><%=datas.converteDeData(String.valueOf(rs02.getString("funcionarioNascimento"))) %></td>
        <td align="left" colspan="2"><%=rs02.getString("funcionarioRg") %></td>
        <td align="left"><%=rs02.getString("funcionarioCpf") %></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      %>
       <tr>
        <td align="left" height="15" colspan="3"><strong>Endereco</strong></td>
      ...
      %>
       <tr>
        <td align="left" height="15" colspan="3"><%=rs02.getString("funcionarioEndereco") %></td>
        <td align="left"><%=rs02.getString("funcionarioNumero") %></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      %> 
       <tr>
        <td align="left" height="15" colspan="3"><strong>Bairro</strong></td>
     ...
     <%ln++; %>
      ...
      %> 
       <tr>
        <td align="left" height="15" colspan="3"><%=rs02.getString("funcionarioBairro") %></td>
        <td align="left"><%=rs02.getString("funcionarioCep") %></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      %>  
       <tr>
        <td align="left" height="15" colspan="3"><strong>Cidade</strong></td>
     ...
     <%ln++; %>
      ...
      %>  
       <tr>
        <td align="left" height="15" colspan="3"><%=rs02.getString("funcionarioCidade") %></td>
        <td align="left"><%=rs02.getString("funcionarioUf") %></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      %>
       <tr>
        <td align="left" height="15" colspan="4"><strong>Complemento</strong></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      %>
       <tr>
        <td align="left" height="15" colspan="4"><%=rs02.getString("funcionarioComplemento") %></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      %> 
       <tr>
        <td align="left" height="15"><strong>Telefone</strong></td>
     ...
     <%ln++; %>
      ...
      %> 
       <tr>
        <td align="left" height="15"><%=rs02.getString("funcionarioTelefone") %></td>
        <td align="left"><%=rs02.getString("funcionarioCelular") %></td>
     ...
     <%ln++; %>
      ...
      %> 
       <tr>
        <td align="left" height="15" colspan="4"><strong>E-mail</strong></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
      ...
      %> 
       <tr>
        <td align="left" height="15" colspan="4"><%=rs02.getString("funcionarioEmail") %></td>
       </tr>
     <%ln++; %>
      <%
      //Verifica se ja preecheu as 54 linhas e da um espaçamento
