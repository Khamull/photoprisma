...
lancamento.empresa.empresaID = Integer.parseInt((String)session.getAttribute("empresaID"));

receber.tipoServico = request.getParameter("servico");
...
<%
//Gera um Lançamento
//verifica se essa conta vem de um serviço ou de uma venda
if(receber.tipoServico.equals("S")){
	st.execute(lancamento.pagaContaReceberServico());
}else{
...
response.sendRedirect("sis_conta_receber_separada.jsp");//Caso der algum problema é só comentar essa linha
%>
