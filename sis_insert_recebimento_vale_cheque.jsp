...
<table align="center" style="width:450px; height:200px; border:1px solid #333">
 ...
 <%} %>
  ...
  <tr>
    <td width="83" align="left">Cliente</td>
  ...
  <tr>
    ...
    <td width="80" align="left"><font color="#000099"><%=rs.getString("vendaID") %></font></td>
    <td width="89" align="left">Forma Pgto</td>
    <td width="128" align="left"><font color="#000099"><%=rs.getString("descricao") %></font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4" align="left">Valor Recebido: <input type="text" name="valorRecebido" maxlength="8" size="20" onkeypress="return numero(this);" value="<%=rs.getString("valor").replace(".",",")%>" /></td>
  </tr>
  <tr>
    <td align="left">
