...
<tr>
  <td align="center" valign="top" bgcolor="#FFFFFF">
    ...
    <form name="form1" action="sis_permitir_manager_exclusao_os.jsp" onsubmit="return verForm(this)">
      ...
      <table width="317" align="center" cellpadding="5" cellspacing="0">
        ...
        <tr bgcolor="#FFFFFF">
          <td colspan="2" align="center">PARA REALIZAR UMA EXCLUS&Atilde;O DE OS &Eacute; NECESS&Aacute;RIO O LOGIN E SENHA DE ADMINISTRADOR.</td>
          </tr>
        <tr bgcolor="#EEEEEE">
