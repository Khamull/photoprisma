...
rs = st.executeQuery(empresa.dadosEmpresa());
%>
...
<body onload="javascript: document.form1.nomeFantasia.focus()">
   ...
   <table width="985" height="440">
    ...
    <!--PRIMEIRA COLUNA-->
     <td valign="top">
      ...
      <table align="center">
       <tr bgcolor="#FFFFEE">
         <td colspan="3" align="center"><u>Unidade: <%=rs.getString("unidade")%></u>
           <input name="unidade" type="hidden" value="<%=rs.getString("unidade")%>"/>
         </td>
       </tr>
       <tr>
