...
<tr>
 ...
 <input type="button" class="botao" onclick="javascript: window.location.href='sis_view_produtos_separados.jsp'" value="Lista Produtos" />&nbsp;
...
<td> 
 ...
 <form name="form1" method="post" action="sis_insert_manager_tipo.jsp" onsubmit="return verForm(this)">
 ...
 <%} %>
  <tr>
   <td colspan="2" align="center"><strong>CADASTRO DE TIPO DE PRODUTO</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="311" align="left"><input type="text" name="tipo" maxlength="100" size="55" /></td>
  </tr>
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left">&nbsp;</td>
  ...
  <tr>
   ...
   <input name="CADASTRAR" type="submit" class="botao" value="Cadastrar" /></td>
   </tr>
 </table>
 </form>
