...
<tr>
 ...
 <input type="button" class="botao" onclick="javascript: window.location.href='sis_view_produtos_separados.jsp'" value="Lista de Materiais" />&nbsp;
...
<tr>
 ...
 <form name="form1" method="post" action="sis_insert_manager_material.jsp" onsubmit="return verForm(this)">
 ...
 <%} %>
  ...
  <tr>
    <td align="left" valign="top" >Nome do Material</td>
    <td align="left"><input type="text" name="nome" maxlength="100" size="47,5" /></td>
