...
<%
//Recupera valores trazidos do Formulário de Cadastro de Funcionarios
...
funcionario.empresa.empresaID				= Integer.parseInt((String)session.getAttribute("empresaID"));
