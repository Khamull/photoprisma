...
<tr>
 ...
 <input type="button" class="botao" onclick="javascript: window.location.href='sis_conta_receber_separada.jsp'" value="Contas a Receber por Loja" />&nbsp;
...
<tr>
 ...
 <br />
  <table width="960" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr bgcolor="#EEEEEE">
    <td width="120" align="left"><strong>N&deg; Venda / O.S.</strong></td>
   ...
   <tr>
    <td height="30" width="120" align="left"><%=rs.getShort("vendaID") %></td>
