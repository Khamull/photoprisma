...
if(request.getParameter("administrador")!=null && request.getParameter("senha")!=null){
	...
	if(rs.next()){
		...
		response.sendRedirect("sis_manager_excluir_os.jsp?OS="+request.getParameter("OS")+"&ANO="+request.getParameter("ANO"));
	}else{
		response.sendRedirect("sis_permitir_exclusao.jsp?erro=2");
	}
